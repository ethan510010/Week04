...
func (x *BookRequest) GetBookId() int32 {
	if x != nil {
		return x.BookId
	}
	return 0
...
var file_book_proto_rawDesc = []byte{
	...
	0x6f, 0x6b, 0x2e, 0x76, 0x31, 0x22, 0x25, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x6f, 0x6f, 0x6b, 0x49, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x62, 0x6f, 0x6f, 0x6b, 0x49, 0x64, 0x22, 0x3e, 0x0a, 0x08,
	0x42, 0x6f, 0x6f, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x28, 0x09, 0x52, 0x08, 0x62, 0x6f, 0x6f, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x43, 0x0a, 0x0b,
	0x42, 0x6f, 0x6f, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x34, 0x0a, 0x07, 0x47,
	0x65, 0x74, 0x42, 0x6f, 0x6f, 0x6b, 0x12, 0x14, 0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x76, 0x31,
	0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x62,
	0x6f, 0x6f, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x22,
...
var file_book_proto_goTypes = []interface{}{
	(*BookRequest)(nil), // 0: book.v1.BookRequest
	(*BookInfo)(nil),    // 1: book.v1.BookInfo
}
var file_book_proto_depIdxs = []int32{
	0, // 0: book.v1.BookService.GetBook:input_type -> book.v1.BookRequest
	1, // 1: book.v1.BookService.GetBook:output_type -> book.v1.BookInfo
...
type BookServiceClient interface {
	GetBook(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookInfo, error)
}
...
func (c *bookServiceClient) GetBook(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookInfo, error) {
	out := new(BookInfo)
...
type BookServiceServer interface {
	GetBook(context.Context, *BookRequest) (*BookInfo, error)
}
...
func (*UnimplementedBookServiceServer) GetBook(context.Context, *BookRequest) (*BookInfo, error) {
